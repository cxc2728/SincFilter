...
void OnFrequencyDomain(char filterType, char kz, char imageFilename[], int rcxres, int rcyres, double m_Real, double m_Imaginary, int m_angles);
...
int main(int argc, char* argv[]) {
	...
	if (argc < 9) {
		...
		std::cout << "Example parameters for LPF: k 0.5 0.5 5 l" << endl;
		std::cout << "Example parameters for HPF: k 0.5 0.5 5 h" << endl;
		std::cout << endl;
		exit(0);
	}
		...
		if ((savedata = fopen(outputFile, "w")) == NULL)
		{
			...
			OnFrequencyDomain(filterType, kz, imageFileName, n1, n2, m_Real, m_Imaginary, m_angles);
